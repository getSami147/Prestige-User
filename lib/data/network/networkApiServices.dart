...
import 'package:prestige/data/appException.dart';
import 'package:prestige/data/network/baseApiServices.dart';
...
class NetworkApiServices extends BaseApiServices {
  ...
  Future formDataPostServices(dynamic url, Map<String,String> data,
      Map<String, String> headers, String? filekey, String? filePath) async {
    ...
    try {
      ...
      if (filePath != null && filePath.isNotEmpty) {
        request.files.add(
            await http.MultipartFile.fromPath(filekey.toString(), filePath));
      }
...
//     if (kDebugMode) {
//       print("status code: ${response.statusCode}");
//       // print("body: ${response.stream.bytesToString()}");
//     }
    switch (response.statusCode) {
      case 200:
        dynamic responseJson =
