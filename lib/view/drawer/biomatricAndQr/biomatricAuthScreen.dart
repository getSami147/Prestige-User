...
import 'package:prestige/view/drawer/biomatricAndQr/qrcode.dart';


class BiomatricAuthScreen extends StatefulWidget {
  const BiomatricAuthScreen({super.key});

  @override
  State<BiomatricAuthScreen> createState() => _BiomatricAuthScreenState();
}
...
class _BiomatricAuthScreenState extends State<BiomatricAuthScreen> {
...
// Navigate to Next Page After Authenticating.....
      if (authenticated) {
 const Qrcodescreen().launch(context,
