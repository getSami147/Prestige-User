...
class _FavoriteProductsScreenState extends State<FavoriteProductsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      provider.getFavoriteProducts(context);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<HomeViewModel>(
      builder: (context, favoriteProduct, child) {
        if (favoriteProduct.pageloading &&
            favoriteProduct.favoriteProducts.isEmpty) {
          return Center(
            child: const CustomLoadingIndicator().paddingTop(spacing_twinty),
          );
        } else if (favoriteProduct.favoriteProducts.isEmpty) {
          return Center(
        ...
        return RefreshIndicator(
          onRefresh: () async {
            await favoriteProduct.getFavoriteProducts(context);
          },
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return GridView.builder(
                ...
                itemBuilder: (context, index) {
                  var filterData = favoriteProduct.favoriteProducts[index];
                          ...
                          Stack(
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: IconButton(
                                  onPressed: () async {
                                    await favoriteProduct.removeFavoriteProduct(
                                        filterData['_id'].toString(), context);

                                    // After removing, refresh the favorite products list
