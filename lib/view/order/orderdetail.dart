...
class _OrderdetailscreenState extends State<Orderdetailscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:
            text(Ordrdetail_Order, fontSize: textSizeLarge, fontWeight: FontWeight.w700),
      ),
      body: FutureBuilder(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      text(items["name"].toString(),overflow: TextOverflow.ellipsis,
                                ...
                                Column(
                                  ...
                                  children: [
                                    text("N ${ammoutFormatter(items["basePrice"].toString().toInt())}",
                                        fontSize: textSizeSMedium,
                                        fontWeight: FontWeight.w600,
                                        color: textGreenColor),
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomBillingRow(
                          ...
                          titleColor: textGreenColor,
                          traillingColor: textGreenColor,
                        )
                      ],
        ...
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            text(Ordrdetail_Track,
                fontSize: textSizeSMedium, fontWeight: FontWeight.w600, color: white)
          ]),
        )
      ],
    );
